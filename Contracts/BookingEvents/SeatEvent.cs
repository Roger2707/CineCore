namespace Contracts.BookingEvents
{
    ...
    public record SeatUpdateCompleted(Guid BookingId, Guid ScreeningId, List<Guid> Seats, string PaymentIntentId, Guid UserId);
    public record SeatUpdateFailed(Guid BookingId, Guid ScreeningId, List<Guid> Seats, string PaymentIntentId, Guid UserId);
